...
import sistemacredenciamento.dao.DocenteDao;
...
public class CadastroDocente extends javax.swing.JFrame {
    ...
    private void btnCadastrarDocenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarDocenteActionPerformed
        ...
        Date ingresso = null;
        try {
            nascimento =  new java.sql.Date(new SimpleDateFormat("dd/MM/yyyy").parse(txtDataNascimento.getText()).getTime());
            ingresso = new java.sql.Date(new SimpleDateFormat("dd/MM/yyyy").parse(txtDataIngresso.getText()).getTime());
        ...
        if(radioBtnSim.isSelected()){
            ehCoordenador = true;
        }else if(radioBtnNao.isSelected()){
            ehCoordenador = false;
        }
        
        Docente docente = new Docente(cod,nome,nascimento,ingresso,ehCoordenador);
        
        DocenteDao dao = new DocenteDao();
        dao.salvarDocente(docente);
    ...
    public static void startCadastroDocente() {
